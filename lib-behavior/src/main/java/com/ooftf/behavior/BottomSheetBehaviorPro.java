...
public class BottomSheetBehaviorPro<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehaviorPro(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ...
        TypedArray b = context.obtainStyledAttributes(attrs, com.ooftf.behavior.R.styleable.BottomSheetBehaviorPro_Layout);
        if (b.hasValue(com.ooftf.behavior.R.styleable.BottomSheetBehaviorPro_Layout_hideHeight)) {
            setHideHeightPx(b.getDimensionPixelSize(com.ooftf.behavior.R.styleable.BottomSheetBehaviorPro_Layout_hideHeight, -1));
        }
        b.recycle();
        //BottomSheetBehaviorPro_Layout
    }
    ...
    public boolean onLayoutChild(
        ...
        if (state == STATE_EXPANDED) {
            ...
            ViewCompat.offsetTopAndBottom(child, parentHeight - hideHeight);
    ...
    public void setHideHeightPx(int hideHeight) {
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull BottomSheetBehaviorPro<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link BottomSheetBehaviorPro#SAVE_PEEK_HEIGHT}, {@link
         * BottomSheetBehaviorPro#SAVE_FIT_TO_CONTENTS}, {@link BottomSheetBehaviorPro#SAVE_HIDEABLE}, {@link
         * BottomSheetBehaviorPro#SAVE_SKIP_COLLAPSED}. It is as if {@link BottomSheetBehaviorPro#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link #SavedState(Parcelable, BottomSheetBehaviorPro)} instead.
         */
        @Deprecated
    ...
    /**
     * A utility function to get the {@link BottomSheetBehaviorPro} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BottomSheetBehaviorPro}.
     * @return The {@link BottomSheetBehaviorPro} associated with the {@code view}.
     */
    @NonNull
    @SuppressWarnings("unchecked")
    public static <V extends View> BottomSheetBehaviorPro<V> from(@NonNull V view) {
        ...
        return (BottomSheetBehaviorPro<V>) behavior;
    }
